...
ICorba::IPista::vetor_objetos_slice* ICorba::IPista_stub::getObjetos()
{
  CORBA::StaticAny __res( _marshaller__a400_ICorba_Sprite );
  ...
  mico_sii_throw( &__req, 
    0);
  return (ICorba::IPista::vetor_objetos_slice*) __res._retn();
}


#ifndef MICO_CONF_NO_POA

ICorba::IPista::vetor_objetos_slice*
ICorba::IPista_stub_clp::getObjetos()
{
  ...
  if (_serv) {
    POA_ICorba::IPista * _myserv = POA_ICorba::IPista::_narrow (_serv);
    if (_myserv) {
      ICorba::IPista::vetor_objetos_slice * __res;
...
class _Marshaller__a400_ICorba_Sprite : public ::CORBA::StaticTypeInfo {
    typedef ICorba::Sprite _MICO_T;
  public:
    ~_Marshaller__a400_ICorba_Sprite();
    StaticValueType create () const;
    void assign (StaticValueType dst, const StaticValueType src) const;
    void free (StaticValueType) const;
    ::CORBA::Boolean demarshal (::CORBA::DataDecoder&, StaticValueType) const;
...
_Marshaller__a400_ICorba_Sprite::~_Marshaller__a400_ICorba_Sprite()
{
}

::CORBA::StaticValueType _Marshaller__a400_ICorba_Sprite::create() const
{
  return (StaticValueType) new _MICO_T[ 400 ];
}

void _Marshaller__a400_ICorba_Sprite::assign( StaticValueType d, const StaticValueType s ) const
{
  for( int i = 0; i < 400; i++ )
    ((ICorba::Sprite *) d)[ i ] = ((ICorba::Sprite *) s)[ i ];
}

void _Marshaller__a400_ICorba_Sprite::free( StaticValueType v ) const
{
  delete[] (_MICO_T *) v;
}

::CORBA::Boolean _Marshaller__a400_ICorba_Sprite::demarshal( ::CORBA::DataDecoder &dc, StaticValueType v ) const
{
  if( !dc.arr_begin() )
    return FALSE;
  for( ::CORBA::ULong i = 0; i < 400; i++ ) {
...
void _Marshaller__a400_ICorba_Sprite::marshal( ::CORBA::DataEncoder &ec, StaticValueType v ) const
{
  ec.arr_begin();
  for( ::CORBA::ULong i = 0; i < 400; i++ )
...
::CORBA::StaticTypeInfo *_marshaller__a400_ICorba_Sprite;
...
struct __tc_init_ICORBA {
  __tc_init_ICORBA()
  {
    ...
    _marshaller__a400_ICorba_Sprite = new _Marshaller__a400_ICorba_Sprite;
  }
  ...
  ~__tc_init_ICORBA()
  {
    ...
    delete static_cast<_Marshaller__a400_ICorba_Sprite*>(_marshaller__a400_ICorba_Sprite);
  }
};
  ...
  try {
    ...
    case 14:
      if( strcmp( __req->op_name(), "getObjetos" ) == 0 ) {
        ::ICorba::IPista::vetor_objetos_slice* _res;
        CORBA::StaticAny __res( _marshaller__a400_ICorba_Sprite );
        __req->set_result( &__res );
        ...
        _res = getObjetos();
        __res.value( _marshaller__a400_ICorba_Sprite, _res );
        __req->write_results();
        ::ICorba::IPista::vetor_objetos_free( _res );
        return true;
      }
      break;
    case 15:
