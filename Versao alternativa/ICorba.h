  ...
  virtual public CORBA::Object
{
  public:
    ...
    typedef SequenceTmpl< Sprite,MICO_TID_DEF> vetor_objetos;
    typedef TSeqVar< SequenceTmpl< Sprite,MICO_TID_DEF> > vetor_objetos_var;
    typedef TSeqOut< SequenceTmpl< Sprite,MICO_TID_DEF> > vetor_objetos_out;
...
extern CORBA::StaticTypeInfo *_marshaller__seq_ICorba_Sprite;
