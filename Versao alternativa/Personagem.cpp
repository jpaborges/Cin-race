...
Direcao Personagem::ColidirPersonagem(Objeto* obj)
{
...
void Personagem::MorrerPersonagem(int tempo)
{
    Objeto::Morrer();
    tempoFim = tempo;
}
...
bool Personagem::criarPersonagem (bool ativo, std::string sprite, Dimensao posicao, Dimensao tamanho, int velocidadeInicial, int municaoInicial, bool spider)
{
	this->strSprite = "NULL";
    this->ativo = ativo;
