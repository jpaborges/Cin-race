...
void Personagem::mudarImagem()
{
    ...
    if (sprite == NULL)
    	std::cout << "ERRO DE IMAGEM do PERSONAGEM:  " << aux;
    ...
    if (!godmod)
    {
        if (retorno != NENHUMA)
        {
            ...
            else
            {
                ...
                if ( ((Obstaculo*)obj)->funcionalidade == -110) // Se a funcionalidade for -110 entao ganha municao
                {
                    municao++;
                }
                else
                {
                    this->velocidade += this->velocidade*0.01*((Obstaculo*)obj)->funcionalidade;//funcionalidade é dado em %
                ...
                {
                    if (((Obstaculo*)obj)->funcionalidade > 0)
                        bonus++;
                    else
                        obstaculoAtingidos++;
                }
